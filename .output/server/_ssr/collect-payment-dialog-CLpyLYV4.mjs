...
import { M as Search, i as Wallet, st as LoaderCircle } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/collect-payment-dialog-CLpyLYV4.js
...
function CollectPaymentDialog({ open, onOpenChange, defaultPackageId, defaultPatientId }) {
	...
	const selectedPackage = findPackage(packageId) || getStoredDailySessions().find((d) => d.id === packageId);
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
											...
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [PAYMENT_PACKAGES.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem, {
												value: item.id,
												children: [
													"[Package] ",
													item.name,
											...
											}, item.id)), getStoredDailySessions().map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem, {
												value: item.id,
												children: [
													"[Daily Session] ",
													item.name,
