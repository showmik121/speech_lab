...
import { $ as Plus, Gt as Ellipsis, H as Repeat, L as Search, Nn as Banknote, W as RefreshCw, Zt as Columns3, cn as ChevronsUpDown, nn as ClipboardCheck, pn as ChevronDown, q as ReceiptText, qt as Download, un as ChevronUp, x as TrendingDown } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/manager.expense.index-oRCVXOYm.js
...
var PENDING_APPROVALS = countBy((record) => record.status === "Pending" || record.status === "Approved");
var RECURRING_EXPENSES = countBy((record) => record.recurring);
var EXPENSE_KPIS = [
	{
		id: "today-expense",
...
function ExpenseFormDialog({ mode, record, onSubmit, trigger }) {
	const [open, setOpen] = (0, import_react.useState)(false);
	const [values, setValues] = (0, import_react.useState)(() => toFormValues(record));
	(0, import_react.useEffect)(() => {
		if (open) setValues(toFormValues(record));
	}, [open, record]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: EXPENSE_KPIS.map((kpi) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KpiCard, { kpi }, kpi.id))
			}),
