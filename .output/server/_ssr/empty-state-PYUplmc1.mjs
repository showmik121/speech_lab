...
//#region node_modules/.nitro/vite/services/ssr/assets/empty-state-PYUplmc1.js
...
function EmptyState({ icon: Icon = Inbox, title, description, action, secondaryAction, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		"data-tsd-source": "/src/components/common/empty-state.tsx:24:5",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			"data-tsd-source": "/src/components/common/empty-state.tsx:30:7"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative flex flex-col items-center",
			"data-tsd-source": "/src/components/common/empty-state.tsx:35:7",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					"data-tsd-source": "/src/components/common/empty-state.tsx:36:9",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "absolute inset-0 rounded-2xl bg-primary/5",
						"aria-hidden": "true",
						"data-tsd-source": "/src/components/common/empty-state.tsx:37:11"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
						className: "relative h-6 w-6",
						"aria-hidden": "true",
						"data-tsd-source": "/src/components/common/empty-state.tsx:41:11"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: "text-base font-semibold tracking-tight text-foreground",
					"data-tsd-source": "/src/components/common/empty-state.tsx:44:9",
					children: title
				}),
				description ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 max-w-md text-sm leading-relaxed text-muted-foreground",
					"data-tsd-source": "/src/components/common/empty-state.tsx:46:11",
					children: description
				}) : null,
				action || secondaryAction ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-7 flex flex-wrap items-center justify-center gap-2.5",
					"data-tsd-source": "/src/components/common/empty-state.tsx:52:11",
