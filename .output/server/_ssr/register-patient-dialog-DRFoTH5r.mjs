...
import { At as CreditCard, Bt as CircleCheck, Cn as Activity, E as ShieldCheck, J as Package, Wt as ChevronRight, _t as Heart, a as Users, f as UserCog, n as X, ot as LoaderCircle, s as User, x as Stethoscope, yt as Hash } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/register-patient-dialog-DRFoTH5r.js
...
function RegisterPatientDialog({ open, onOpenChange }) {
	...
	const basePrice = (0, import_react.useMemo)(() => {
		...
		if (serviceType === "package") return selectedService.price;
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					className: cn("flex items-center gap-3 rounded-xl border-2 p-4 text-left transition-all cursor-pointer", serviceType === "package" ? "border-emerald-500 bg-emerald-500/10" : "border-border bg-card hover:border-muted-foreground/30 hover:bg-muted/30"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("grid h-10 w-10 place-items-center rounded-xl", serviceType === "package" ? "bg-emerald-500 text-white" : "bg-muted text-muted-foreground"),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Package, { className: "h-5 w-5" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("font-bold text-[13px]", serviceType === "package" ? "text-emerald-600 dark:text-emerald-400" : "text-foreground"),
						children: "Package"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-[11.5px] text-muted-foreground",
						children: [activePackages.length, " active plans"]
					})] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: () => onServiceTypeChange("therapy"),
					className: cn("flex items-center gap-3 rounded-xl border-2 p-4 text-left transition-all cursor-pointer", serviceType === "therapy" ? "border-blue-500 bg-blue-500/10" : "border-border bg-card hover:border-muted-foreground/30 hover:bg-muted/30"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("grid h-10 w-10 place-items-center rounded-xl", serviceType === "therapy" ? "bg-blue-500 text-white" : "bg-muted text-muted-foreground"),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stethoscope, { className: "h-5 w-5" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("font-bold text-[13px]", serviceType === "therapy" ? "text-blue-600 dark:text-blue-400" : "text-foreground"),
						children: "Therapy"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-[11.5px] text-muted-foreground",
						children: [activeTherapies.length, " therapy types"]
					})] })]
				})]
			})] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						"Select ",
						serviceType === "package" ? "Package" : "Therapy",
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: (serviceType === "package" ? activePackages : activeTherapies).map((item) => {
					const price = serviceType === "package" ? item.price : item.fees[0]?.price ?? 0;
					const desc = serviceType === "package" ? item.durationLabel : item.category;
					const isSelected = selectedServiceId === item.id;
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => onSelectedServiceIdChange(item.id),
						className: cn("flex items-start gap-3 rounded-xl border-2 p-3.5 text-left transition-all w-full cursor-pointer", isSelected ? serviceType === "package" ? "border-emerald-500 bg-emerald-500/8 shadow-xs" : "border-blue-500 bg-blue-500/8 shadow-xs" : "border-border bg-card hover:border-muted-foreground/30 hover:bg-muted/20"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("mt-0.5 grid h-7 w-7 shrink-0 place-items-center rounded-lg text-xs font-bold", isSelected ? serviceType === "package" ? "bg-emerald-500 text-white" : "bg-blue-500 text-white" : "bg-muted text-muted-foreground"),
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: cn("mt-1 text-[13px] font-bold tabular-nums", isSelected ? serviceType === "package" ? "text-emerald-600 dark:text-emerald-400" : "text-blue-600 dark:text-blue-400" : "text-foreground"),
