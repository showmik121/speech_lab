...
import { At as Ellipsis, Ct as Hand, En as Activity, K as Plus, T as Sparkles, W as Power, X as PencilLine, c as User, cn as Brain, dt as LoaderCircle, ht as Layers, o as Users, rt as Minus, t as Zap } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/manager.therapy.index-BLzkOsIu.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var THERAPY_CATEGORY_TONE = {
...
var THERAPY_TYPES = [
	{
		...
		description: "Addresses speech delay, language delay, communication difficulties, and stuttering/তোতলামি.",
		goals: [
			"Speech Delay",
			"Language Delay",
	...
	},
	{
		...
		description: "Applied Behaviour Analysis for behavioural and developmental support.",
	...
	},
	{
		...
		description: "Builds functional and developmental skills through purposeful activity and play.",
	...
	},
	{
		...
		shortName: "SIT",
		category: "Sensory",
		description: "Helps children with sensory-related difficulties process and respond to sensory information.",
	...
	},
	{
		...
		shortName: "KIT",
		category: "Other",
		description: "KIT — a specialised therapy programme available at the branch.",
	...
	},
	{
		...
		shortName: "1:1",
		category: "Individual",
		description: "One-to-one therapy tailored to the child's individual needs and goals.",
	...
	},
	{
		...
		shortName: "Group",
		category: "Group",
		description: "Small group sessions focusing on communication, social interaction, group behaviour and participation.",
		goals: [
			"Communication",
			"Social interaction",
			"Group behaviour",
