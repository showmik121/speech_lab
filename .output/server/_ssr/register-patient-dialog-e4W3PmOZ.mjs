...
//#region node_modules/.nitro/vite/services/ssr/assets/register-patient-dialog-e4W3PmOZ.js
...
function StepPayment({ selectedServicePrice, selectedServiceId, serviceType }) {
	...
	const [paymentType, setPaymentType] = (0, import_react.useState)(isMonthlyPlan ? "Monthly" : "Full Payment");
	...
	(0, import_react.useEffect)(() => {
		if (isMonthlyPlan) setPaymentType("Monthly");
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: isMonthlyPlan ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: "Monthly",
							children: "Monthly"
