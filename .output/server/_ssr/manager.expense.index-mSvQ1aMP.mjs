...
import { Dt as Ellipsis, I as RefreshCw, Kt as ChevronDown, Mt as Columns3, Ot as Download, Pt as Clock, R as ReceiptText, U as Plus, Ut as ChevronUp, Vt as ChevronsUpDown, g as TrendingDown, i as Wallet, j as Search, xn as ArrowDownRight } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/manager.expense.index-mSvQ1aMP.js
...
function getFreshEmptyForm(defaultCategory) {
...
function toFormValues(record, defaultCategory) {
	if (!record) return getFreshEmptyForm(defaultCategory);
	return {
...
function ExpenseTypeCards({ onAdd }) {
	const { totalExpenses, dailyExpenses, monthlyExpenses, pendingCount, expenses } = useExpenseStore();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				interactive: true,
				className: "relative overflow-hidden p-5 border-rose-500/25 bg-gradient-to-br from-card via-card to-rose-500/10 shadow-card",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start justify-between gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "inline-flex items-center gap-1 rounded-full bg-rose-500/10 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wider text-rose-600 dark:text-rose-400",
							children: "Total Expenses"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-[12px] font-medium text-muted-foreground",
							children: "All recorded branch spending"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-rose-500/15 text-rose-600 dark:text-rose-400 shadow-xs",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: formatTaka(totalExpenses)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-3 flex items-center justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-[12px] font-medium text-rose-600 dark:text-rose-400 flex items-center gap-1",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowDownRight, { className: "h-3.5 w-3.5" }),
								" ",
								expenses.length,
								" vouchers recorded"
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExpenseFormDialog, {
							mode: "create",
							onSubmit: onAdd,
							trigger: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								size: "sm",
								variant: "outline",
								className: "h-7 text-[11.5px] gap-1 border-rose-500/30 text-rose-600 hover:bg-rose-500/10",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3 w-3" }), " Quick Add"]
							})
						})]
					})
				]
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "mt-2 text-[12px] font-medium text-muted-foreground",
							children: "Daily branch operational cost"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReceiptText, { className: "h-5 w-5" })
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-[28px] font-bold leading-none tracking-tight tabular-nums text-foreground",
						children: formatTaka(dailyExpenses)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-[12px] text-muted-foreground",
						children: "Live daily total"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-[28px] font-bold leading-none tracking-tight tabular-nums text-foreground",
						children: formatTaka(monthlyExpenses)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-[12px] text-muted-foreground",
						children: "Running month aggregate"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "mt-2 text-[12px] font-medium text-muted-foreground",
							children: "Awaiting manager review"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
