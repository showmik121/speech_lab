...
//#region node_modules/.nitro/vite/services/ssr/assets/score-rating-CAAjQoIO.js
...
function ScoreRating({ id, label, value, onChange, hint }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		"data-tsd-source": "/src/components/assessments/score-rating.tsx:30:5",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3",
			"data-tsd-source": "/src/components/assessments/score-rating.tsx:31:7",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "min-w-0",
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:32:9",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					id: `${id}-label`,
					className: "truncate text-[13px] font-medium text-foreground",
					"data-tsd-source": "/src/components/assessments/score-rating.tsx:33:11",
					children: label
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-0.5 text-[12px] text-muted-foreground",
					"data-tsd-source": "/src/components/assessments/score-rating.tsx:36:11",
				...
				label: `${value}/5`,
				dot: false,
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:40:9"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			role: "radiogroup",
			"aria-labelledby": `${id}-label`,
			className: "mt-3 grid grid-cols-5 gap-1.5",
			"data-tsd-source": "/src/components/assessments/score-rating.tsx:43:7",
			children: SCORES.map((score) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:49:11",
				children: score
			}, score))
		})]
	});
...
function ScoreMeter({ label, score, note }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		"data-tsd-source": "/src/components/assessments/score-rating.tsx:74:5",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3",
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:75:7",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "min-w-0 truncate text-[13px] font-medium text-foreground",
					"data-tsd-source": "/src/components/assessments/score-rating.tsx:76:9",
					children: label
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, {
					tone: SCORE_TONE[score],
					label: `${score}/5`,
					dot: false,
					"data-tsd-source": "/src/components/assessments/score-rating.tsx:77:9"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-3 flex items-center gap-1.5",
				"aria-hidden": "true",
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:79:7",
				children: SCORES.map((step) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: cn("h-1.5 flex-1 rounded-full", step <= score ? score <= 2 ? "bg-danger" : score === 3 ? "bg-warning" : score === 4 ? "bg-info" : "bg-success" : "bg-muted"),
					"data-tsd-source": "/src/components/assessments/score-rating.tsx:81:11"
				}, step))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-[12px] text-muted-foreground",
				"data-tsd-source": "/src/components/assessments/score-rating.tsx:98:7",
