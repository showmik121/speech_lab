...
export function EditTherapyDialog({
  open,
  onOpenChange,
  item,
}: {
    ...
    <Dialog open={open} onOpenChange={(next) => { if (!next) close(); else onOpenChange(true); }}>
      <DialogContent className="max-h-[92vh] max-w-2xl overflow-y-auto rounded-xl">
        ...
        <div className="grid gap-5 py-2 sm:grid-cols-2">
          <FormField id="edit-therapy-name" label="Therapy name" required>
            <Input
          ...
          <FormField id="edit-therapy-short" label="Short name / abbreviation">
            <Input
          ...
          <FormField id="edit-therapy-category" label="Category" required>
            <Select value={category} onValueChange={setCategory}>
              <SelectTrigger id="edit-therapy-category">
          ...
          <FormField id="edit-therapy-status" label="Status" required>
            <Select value={status} onValueChange={setStatus}>
              <SelectTrigger id="edit-therapy-status">
