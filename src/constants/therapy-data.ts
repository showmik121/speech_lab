...
export type TherapyStatus = "Scheduled" | "Completed" | "Ongoing" | "Missed" | "Cancelled";

export const THERAPY_STATUS_TONE: Record<TherapyStatus, StatusTone> = {
  Scheduled: "info",
  Completed: "success",
  Ongoing: "warning",
  Missed: "danger",
...
export type TherapyMode = "Individual Therapy" | "Group Therapy";

export type TherapyProgressSkill = {
  key: string;
  label: string;
  /** 0 — 100 */
  value: number;
...
export type TherapySession = {
  ...
  progressSkills: TherapyProgressSkill[];
  group: {
    groupName: string;
    sessionTopic: string;
...
export const THERAPY_MODES: TherapyMode[] = ["Individual Therapy", "Group Therapy"];
...
export const THERAPY_STATUSES: TherapyStatus[] = [
  "Scheduled",
  "Completed",
  "Ongoing",
  "Missed",
...
export const THERAPY_EQUIPMENT = [
...
export const THERAPY_DATE_RANGES = [
...
export const SESSION_GOAL_SKILLS = [
  "Communication",
  "Eye Contact",
  "Speech Clarity",
  "Vocabulary",
...
function progressTone(value: number): StatusTone {
...
function skills(values: [number, number, number, number, number, number]): TherapyProgressSkill[] {
  const labels = [
...
export const THERAPY_SESSIONS: TherapySession[] = [
  {
    ...
    assessmentSummary:
      "Consistent substitution of /r/ and /s/ sounds in conversational speech. Comprehension age appropriate.",
    therapyPlan:
      "Twice weekly articulation therapy for 3 months with guardian-led daily practice at home.",
    ...
    goals: {
      ...
      activities: ["Mirror drills", "Picture naming", "Sentence repetition"],
    ...
    notes: {
      ...
      activitiesPerformed:
        "Mirror-based articulation drills, 40 picture-naming trials, phrase-level carryover practice.",
      patientResponse:
        "Highly cooperative, achieved 78% accuracy at word level with occasional visual cues.",
      ...
      therapistNotes:
        "Good motivation. Guardian is consistent with practice logs which is accelerating carryover.",
    },
    progressSkills: skills([74, 82, 68, 71, 65, 70]),
    group: null,
  ...
  },
  {
    ...
    assessmentSummary:
      "Vocabulary approximately 18 months behind chronological age. Receptive skills stronger than expressive.",
    ...
    goals: {
      ...
      activities: ["Picture description", "Story sequencing", "Modelled play"],
    ...
    progressSkills: skills([42, 55, 34, 40, 36, 45]),
    group: null,
  ...
  },
  {
    ...
    assessmentSummary:
      "Moderate stammering with block-type disfluencies, most prominent in classroom settings.",
    ...
    goals: {
      ...
      activities: ["Easy onset drills", "Conversational practice", "Reading aloud"],
    ...
    progressSkills: skills([88, 90, 86, 84, 80, 85]),
    group: null,
  ...
  },
  {
    ...
    equipment: ["Sensory Swing", "Bubble Kit", "Therapy Ball"],
    status: "Ongoing",
    attendance: "Present",
    progress: 46,
    diagnosis: "Pending formal assessment",
    assessmentSummary:
      "Limited joint attention and reduced peer interaction. Sensory seeking behaviour observed.",
    ...
    goals: {
      ...
      targetSkills: ["Social Interaction", "Eye Contact", "Turn Taking"],
      activities: ["Circle time greeting", "Turn-taking game", "Sensory break"],
    ...
    progressSkills: skills([44, 38, 40, 48, 52, 42]),
    group: {
      ...
      remarks:
        "Strong engagement overall. One child absent due to illness; guardian informed the front desk.",
      members: [
        {
          id: "nusrat-jahan",
          name: "Nusrat Jahan",
  ...
  },
  {
    ...
    goals: {
      ...
      targetSkills: ["Speech Clarity", "Attention"],
      activities: ["Humming warm-up", "Resonant phrase practice", "Vocal hygiene review"],
    ...
    progressSkills: skills([30, 45, 26, 33, 38, 29]),
    group: null,
  ...
  },
  {
    ...
    assessmentSummary:
      "Fine motor delay with reduced bilateral coordination affecting handwriting readiness.",
    ...
    goals: {
      ...
      activities: ["Bead threading", "Balance work", "Pencil grip practice"],
    ...
    progressSkills: skills([58, 66, 54, 60, 63, 68]),
    group: null,
  ...
  },
  {
    ...
    assessmentSummary:
      "Phonological processing weakness affecting word retrieval and classroom participation.",
    ...
    goals: {
      ...
      activities: ["Category naming race", "Group storytelling", "Peer feedback round"],
    ...
    progressSkills: skills([70, 72, 64, 76, 74, 66]),
    group: {
  ...
  },
  {
    ...
    progressSkills: skills([20, 34, 16, 22, 28, 24]),
    group: null,
  ...
  },
  {
    ...
    therapist: "Dr. Sabrina Chowdhury",
    equipment: ["Sensory Swing", "Tablet with AAC App", "Therapy Ball"],
    status: "Scheduled",
    attendance: "Rescheduled",
    progress: 55,
    diagnosis: "Pending multidisciplinary assessment",
    assessmentSummary:
      "Emerging AAC user with sensory regulation needs and limited spontaneous requesting.",
    ...
    goals: {
      ...
      targetSkills: ["Communication", "Eye Contact", "Attention"],
      activities: ["AAC requesting", "Sensory circuit", "Structured play"],
    ...
    progressSkills: skills([56, 48, 44, 58, 50, 52]),
    group: null,
  ...
  },
  {
    ...
    assessmentSummary:
      "Difficulty following two-step instructions and reduced vocabulary comprehension.",
    ...
    goals: {
      ...
      targetSkills: ["Communication", "Attention", "Vocabulary"],
      activities: ["Instruction following", "Object identification", "Listening game"],
    ...
    progressSkills: skills([46, 52, 38, 42, 40, 48]),
    group: null,
  ...
  },
  {
    ...
    goals: {
      ...
      activities: ["Grip strengthening", "Writing endurance", "Core stability circuit"],
    ...
    progressSkills: skills([64, 70, 60, 66, 62, 72]),
    group: null,
  ...
  },
  {
    ...
    goals: {
      ...
      activities: ["Greeting circle", "Shared play", "Group song"],
    ...
    progressSkills: skills([34, 30, 28, 38, 32, 36]),
    group: {
      ...
      present: 3,
      absent: 1,
      activities: ["Greeting circle", "Shared bubble play", "Group song", "Goodbye routine"],
...
export const THERAPY_BRANCH_OPTIONS = Array.from(
  new Set(THERAPY_SESSIONS.map((session) => session.branch)),
).sort();

function isToday(date: string) {
  return new Date(date).toDateString() === new Date(TODAY_ISO).toDateString();
}

function isUpcoming(date: string) {
  return new Date(date).getTime() > new Date(TODAY_ISO).getTime();
}

const countBy = (predicate: (session: TherapySession) => boolean) =>
  String(THERAPY_SESSIONS.filter(predicate).length);

export const THERAPY_KPIS: Kpi[] = [
  {
    id: "today",
  ...
  },
  {
    ...
    delta: { value: "+6 this month", direction: "up" },
  },
  {
    id: "group",
    label: "Group Therapy",
    ...
    delta: { value: "+1 this month", direction: "up" },
  },
  {
    id: "completed",
  ...
  },
  {
    ...
    delta: { value: "Live", direction: "flat" },
  },
  {
    id: "cancelled",
    label: "Cancelled Sessions",
    value: countBy(
      (session) => session.status === "Cancelled" || session.status === "Missed",
    ),
    icon: XCircle,
    tone: "danger",
  ...
  },
  {
    ...
    tone: "primary",
    hint: "Next 7 days",
    delta: { value: "+3 booked", direction: "up" },
  },
  {
    id: "monthly",
...
export const THERAPY_LIST_ICON = Activity;

export function findTherapySession(id: string) {
  return THERAPY_SESSIONS.find(
    (session) => session.id === id || session.code.toLowerCase() === id.toLowerCase(),
  );
}

export function averageProgress(sessionSkills: TherapyProgressSkill[]) {
