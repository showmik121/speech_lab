...
export const PAYMENT_PACKAGES: PaymentPackage[] = [
  ...
  },
  {
    ...
    type: "Daily",
    description:
      "Pay-as-you-go single therapy sitting. Ideal for guardians travelling from outside Dhaka.",
    price: 1200,
    registrationFee: 500,
    discount: 0,
    durationLabel: "1 day",
  ...
  },
  {
    ...
    type: "Online Booking",
    description:
      "Video assessment slot booked online with an advance payment and a written screening summary.",
    price: 2500,
    registrationFee: 0,
    discount: 0,
